...
This repo contains a collection of programs I and other contributors wrote during the Artificial Intelligence course.
...
### Steps to contribute
- Create a [fork](https://github.com/mhmdsami/ai/fork) of this repo.
- Clone it locally!
```
git clone https://github.com/<your-username>/ai
```
